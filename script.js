function calcularNumeroDeNotas() {
  ...
  if (valorSaque <= 0) {
    ...
    document.getElementById("resultado").innerHTML = "Valor inválido. Insira um valor válido para o saque.";
  ...
  if (valorSaque > 0) {
    document.getElementById("exampleModalLabel").innerHTML = "Erro";
    document.getElementById("resultado").innerHTML = "Saque não é possível com as notas disponíveis.";
